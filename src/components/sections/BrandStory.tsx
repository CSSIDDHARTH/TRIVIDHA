...
export default function BrandStory() {
  ...
  return (
    <section ref={containerRef} className="py-24 md:py-48 px-6 overflow-hidden relative">
      ...
      {/* Background Text */}
      <h2 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[30vw] md:text-[20vw] font-serif opacity-[0.015] whitespace-nowrap pointer-events-none select-none">
        TRADITION
      </h2>
    </section>
  );
