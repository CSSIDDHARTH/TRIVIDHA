...
export default function Footer() {
  return (
    <footer className="bg-brand-black pt-24 md:pt-32 pb-12 px-6 border-t gold-border">
      <div className="max-w-screen-2xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-16 mb-24 md:mb-32">
          {/* Brand Column */}
          <div className="sm:col-span-2 md:col-span-1">
            <div className="mb-8">
              <img src="/images/logo.png" alt="TRIVIDHA" className="h-[100px] md:h-[160px] object-contain" />
            ...
            <p className="text-[11px] font-sans font-light tracking-widest opacity-40 leading-relaxed uppercase max-w-sm">
          ...
          <div className="mt-4 md:mt-0">
            <h5 className="text-[9px] uppercase tracking-[0.4em] text-brand-gold mb-6 md:mb-8 font-medium">Collection</h5>
          ...
          <div className="mt-4 md:mt-0">
            <h5 className="text-[9px] uppercase tracking-[0.4em] text-brand-gold mb-6 md:mb-8 font-medium">Journal</h5>
            <ul className="space-y-4 text-[10px] uppercase font-sans tracking-widest opacity-60">
          ...
          {/* Newsletter */}
          <div className="mt-4 md:mt-0">
            <h5 className="text-[9px] uppercase tracking-[0.4em] text-brand-gold mb-6 md:mb-8 font-medium">Concierge</h5>
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t gold-border gap-6 md:gap-8">
          <p className="text-[9px] uppercase tracking-[0.2em] opacity-40 order-3 md:order-1">
          ...
          <div className="flex gap-8 text-[9px] uppercase tracking-[0.2em] opacity-40 order-2 md:order-3">
